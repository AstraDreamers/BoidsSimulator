...
namespace manager {
    ...
    class manager_entity {
      public:
        ...
        manager_entity(sf::Vector2u window_size, core::simulation_parameters &simulation_parameters);
        ~manager_entity();
      ...
      private:
        ...
        sf::VertexArray render_array_{sf::PrimitiveType::Points, config::simulation::init_object_count};

        std::array<float, config::simulation::init_object_count> array_position_x_{};
        std::array<float, config::simulation::init_object_count> array_position_y_{};
        std::array<float, config::simulation::init_object_count> array_velocity_x_{};
        std::array<float, config::simulation::init_object_count> array_velocity_y_{};
        std::array<float, config::simulation::init_object_count> array_acceleration_x_{};
        std::array<float, config::simulation::init_object_count> array_acceleration_y_{};
    };
} // namespace manager