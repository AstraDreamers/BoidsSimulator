...
namespace core {
    ...
    class core {
      ...
      private:
        ...
        std::unique_ptr<manager::manager_entity> manager_entity_{nullptr};
        std::unique_ptr<manager::manager_ui>     manager_ui_{nullptr};
        ...
        simulation_parameters simulation_parameters_{
            ...
            .gain_cohesion   = config::simulation::init_gain_cohesion,
            .vision_range    = config::simulation::init_vision_range,
        };
    };
} // namespace core