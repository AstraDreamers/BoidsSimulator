...
void slider::update() {
  ...
  sf::Color color = linear_interpolation();
...
sf::Color slider::linear_interpolation() {
  return sf::Color(static_cast<uint8_t>(m_color_inactive.r + m_color_fade * (m_color_active.r - m_color_inactive.r)),
